...
Run: `python ./scripts/resolve-customization.py bmad-agent-builder --key inject --key additional_resources`
...
Run: `python ./scripts/resolve-customization.py bmad-agent-builder --key inject.after`
