---
title: 'Outcome-Driven Prompt Quality'
description: The canon for what earns its place in anything you build with a prompt, from the core test through the two-version comparison to the habit that keeps prompts lean
---
